...
public class MainFrame extends BaseFrame implements LeftMenuAdapter.Listener {
	...
	private List<Lembrete> buildLembreteList() {
		List<String> lembreteTextList = new ArrayList<>();
		if (lembreteTextJTA.getText() != null) {
			lembreteTextList = LembreteTextProcessor.fromTextCopied(lembreteTextJTA.getText()).processToList();
		}
